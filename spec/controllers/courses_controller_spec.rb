...
RSpec.describe CoursesController, type: :controller do
  ...
  ######################################################################
   describe "show_all_course(index)" do
    ...
    let(:course) { Course.create!(course: "CN320", coursename: "Windows Administrator", 
    lecturer: "Supakit Prueksaaroon", semester: "1" , year: "2014") }
  ...
  ######################################################################
    ...
    it "should show detail of course" do
      course =  Course.create!(course: "CN320", coursename: "Windows Administrator", 
      lecturer: "Supakit Prueksaaroon", semester: "1" , year: "2014")
      get :show ,:id => 1
    end
  end
  ...
  ######################################################################
    describe "new and create (Happy path)" do
        ...
        it 'should create a new course on new' do
            course = {:course => "CN408", :coursename => "Windows Administrator", :lecturer => "Supakit Prueksaaroon", 
    ...
    describe "new and create (sad path)" do
		...
		it 'should not create a new course' do
		    course = {:course => "", :coursename => "Windows Administrator", :lecturer => "Supakit Prueksaaroon", 
		    :semester => "1" , :year => "2014"}
            post :create, {:course => course}
  ...
  describe "update course (happy path)"do
    it 'should update course' do
      course = Course.create!(course: "CN320", coursename: "Windows Administrator", 
      lecturer: "Supakit Prueksaaroon", semester: "1" , year: "2014")
      course1 = {:course => "CN320", :coursename => "Windows Administrator", 
      :lecturer => "Supakit Prueksaaroon", :semester => "1" , :year => "2015" , :room => "306"}
      #post :create, {:course => course}
  ...
  describe "update course (sad path)"do
   it 'should update course' do
      ...
      course = Course.create!(course: "CN320", coursename: "Windows Administrator", 
      lecturer: "Supakit Prueksaaroon", semester: "1" , year: "2014")
      course1 = {:course => "", :coursename => "Windows Administrator", 
      :lecturer => "Supakit Prueksaaroon", :semester => "1" , :year => "2014"}
    #   post :create, {:course => course}
      put :update, {:id => 1 , :course => course1}
      c = Course.where(id: "1")
