...
class LecturersControllerTest < ActionController::TestCase
  ...
  test "should create lecturer" do
    assert_difference('Lecturer.count') do
      post :create, lecturer: { department: @lecturer.department, faculty: @lecturer.faculty, identificationnumber: @lecturer.identificationnumber, moreinfo: @lecturer.moreinfo, name: @lecturer.name }
    end
  ...
  test "should update lecturer" do
    patch :update, id: @lecturer, lecturer: { department: @lecturer.department, faculty: @lecturer.faculty, identificationnumber: @lecturer.identificationnumber, moreinfo: @lecturer.moreinfo, name: @lecturer.name }
    assert_redirected_to lecturer_path(assigns(:lecturer))
  end
